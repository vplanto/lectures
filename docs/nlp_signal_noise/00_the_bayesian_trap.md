...
Позначимо:
* $P(D) = 0.001$ — апріорна ймовірність хвороби (*Prior*).
* $P(\neg D) = 0.999$ — ймовірність, що людина здорова.
* $P(+ \mid D) = 0.99$ — чутливість тесту (*Sensitivity*).
* $P(- \mid \neg D) = 0.99$ — специфічність тесту (*Specificity*).
* $P(+ \mid \neg D) = 0.01$ — хибнопозитивний результат (*False Positive*).

Нас цікавить $P(D \mid +)$ — ймовірність хвороби за умови позитивного тесту.
...
Тепер обчислюємо $P(D \mid +)$:

$$
P(D \mid +) = \frac{0.99 \cdot 0.001}{0.01098} = \frac{0.00099}{0.01098} \approx 0.0902
$$
...
$$
P(D \mid +) = \frac{99}{1,098} \approx 0.0902 = 9.02\%
$$
...
$$
P(\text{Критичний збій} \mid \text{Alert}) = \frac{P(\text{Alert} \mid \text{Збій}) \cdot P(\text{Збій})}{P(\text{Alert})}
$$
...
$$
P(\text{Збій} \mid \text{Alert}) = \frac{0.99 \cdot 0.0001}{0.0101} \approx 0.0098 = 0.98\%
$$
