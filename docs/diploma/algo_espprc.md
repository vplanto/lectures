...
Нехай $G=\left(V,A\right)$ - граф, де $A$ — множина дуг і $V = \left\{ v_1, \dots, v_n \right\}$ — множина вузлів, що включає вузол відправлення (з якого виходимо) $p$ і вузол призначення $d$ (в який потрібно потрапити). 
